      ...
      <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <input type="text" name="short_description" class="form-control @error('short_description') is-invalid @enderror" value="{{ old('short_description') }}" placeholder="A brief hook sentence for the blog listing page">
          ...
          <div class="col-12 mt-4">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="meta_title" class="form-control" placeholder="Defaults to Article Title" value="{{ old('meta_title') }}">
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold">SEO Keywords</label>
                <input type="text" name="keywords" class="form-control" placeholder="e.g. storyloom, memory book, family illustration" value="{{ old('keywords') }}">
              </div>
              <div class="col-12">
                <label class="form-label fw-semibold">SEO Meta Description</label>
                <textarea name="meta_description" class="form-control" rows="2" placeholder="Defaults to Short Summary">{{ old('meta_description') }}</textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-4 pt-3 border-top d-flex gap-2">
          <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Create Post</button>
