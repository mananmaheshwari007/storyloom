...
@section('title', 'Add New Shelf Item')
@section('page_title', 'Create Portfolio Shelf Item')
      ...
      <form action="{{ route('admin.portfolio.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category') }}" placeholder="e.g. For a husband — on the loom" required>
            @error('category')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="mt-4 pt-3 border-top d-flex gap-2">
          <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Create Shelf Item</button>
