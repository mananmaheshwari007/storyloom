            ...
            <div class="card-body">
                <form action="{{ route('admin.library.settings') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="library_hero_heading" class="form-control form-control-sm" rows="2" required>{{ setting('library_hero_heading', 'Read one. Then<br>imagine <em style="font-family: \'Cormorant Garamond\', Cormorant, Georgia, serif; font-style: italic; font-weight: 500; color: rgb(181, 91, 41);">yours.</em>') }}</textarea>
                    </div>
