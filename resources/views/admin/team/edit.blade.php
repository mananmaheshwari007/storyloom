        ...
        <form action="{{ route('admin.team.update', $team) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" name="designation" value="{{ old('designation', $team->designation) }}" required>
                    @error('designation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="url" class="form-control" id="instagram" name="social_links[instagram]" value="{{ old('social_links.instagram', isset($team->social_links['instagram']) ? $team->social_links['instagram'] : '') }}">
                </div>
                <div class="col-md-6">
                    <label for="twitter" class="form-label">Twitter / X Profile URL</label>
                    <input type="url" class="form-control" id="twitter" name="social_links[twitter]" value="{{ old('social_links.twitter', isset($team->social_links['twitter']) ? $team->social_links['twitter'] : '') }}">
                </div>
            </div>

            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    <label for="photo_file" class="form-label">Upload New Profile Photo (Optional)</label>
                    ...
                    @if($team->photo)
                        <div class="mt-2 text-muted" style="font-size: 0.85rem;">
                            Current Photo: <code>{{ $team->photo }}</code>
                            <div class="mt-1"><img src="{{ asset($team->photo) }}" alt="Preview" height="80" class="border rounded"></div>
                        </div>
                    @endif
                </div>
                <div class="col-md-6">
            ...
            <button type="submit" class="btn btn-primary px-4 py-2"><i class="bi bi-save me-1"></i> Update Team Member</button>
