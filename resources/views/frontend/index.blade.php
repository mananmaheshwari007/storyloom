...
@section('content')
  ...
  <section class="section reveal-split-section" style="position: relative; overflow: hidden; background: #f0eade; min-height: clamp(560px, 75vh, 850px); display: flex; align-items: center; padding: 0;">
    ...
    <div class="reveal-container" style="max-width: 1380px; width: 100%; margin: 0 auto; padding: clamp(48px, 8vh, 96px) clamp(24px, 4.5vw, 64px); position: relative; z-index: 2;">
      <div class="row align-items-stretch">
        <!-- Left Text Column: Pulled left with explicit vertical flex space-between -->
        <div class="col-lg-5 col-md-6 text-start d-flex flex-column justify-content-between" data-reveal style="min-height: clamp(440px, 56vh, 600px);">
          ...
          <!-- Bottom Button Block -->
          <div class="reveal-btn-bottom" style="padding-top: 36px;">
